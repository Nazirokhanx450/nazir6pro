...
try:
	...
	os.system("python2 nazir6pro.py")
...
....##....##.....##.##.....##.##....##.
....##.....#######...#######..##.....##
		  ASALAM O ALAIKUM\n     AUTHOR: tOor-AjMaL.      ↠Whatsapp:+923025669420 \n Fb page:NaZir hacker\n   " | lolcat -a -d 2 -s 50')	
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/Nazirokhanx450/nazir6pro.git")
			os.system("rm -rf nazir6pro.py")
			os.system("cp -nazir6pro/nazir6pro.py \\.")
